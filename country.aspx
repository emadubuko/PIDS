<%@ Page Title="" Language="C#" MasterPageFile="~/pids.master" AutoEventWireup="true" CodeFile="country.aspx.cs" Inherits="_Country" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="panel-primary"> 
        <div class="panel-heading">
            <h1><i class="fa-flag"></i> Countries</h1>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 form-group-sm">
                <div class="panel panel-default repeater">
                    <asp:GridView ID="gvListCountry" runat="server" AllowPaging="True" CssClass="myGridClass" AutoGenerateColumns="true" ShowFooter="true" 
    ...
    <div class="modal fade" id="modal-popup" tabindex="-1" role="dialog" aria-labelledby="modal-popup" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <asp:Panel ID="country" runat="server">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 form-group-sm">
                                <small>Country Acronym</small>
