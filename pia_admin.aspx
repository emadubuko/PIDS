<%@ Page Title="" Language="C#" MasterPageFile="~/pids.master" AutoEventWireup="true" CodeFile="pia_admin.aspx.cs" Inherits="_PIAAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
        <script type="text/javascript">
            function piapercentChange() {
                var varPiaFigure = document.getElementById('<%= pia_figure.ClientID %>').value;
                document.getElementById('<%= pia_value.ClientID %>').value = varPiaFigure/100;
            }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel-primary">
        <div class="panel-heading row">
            <h1><i class="icon-bar-chart"></i> PIA Administration</h1>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 form-group-sm">
                <div class="panel panel-default repeater">
                    <asp:GridView ID="gvListPIAAdmin" runat="server" AllowPaging="True" CssClass="myGridClass" AutoGenerateColumns="true" 
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">
                        <label> PIA Admin</label>
                    </h3>
                </div>

                <asp:Panel ID="pia_admin" runat="server">
                    <asp:HiddenField ID="rec_id" runat="server" />
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 form-group-sm">
                                <small>Date</small>
                                <asp:textbox id="pia_date" runat="server" cssclass="form-control"></asp:textbox>
                            </div>
                            <div class="col-md-12 col-sm-12 form-group-sm">
                                <small>PIA Figure</small>
                                <asp:textbox id="pia_figure" runat="server" cssclass="form-control" onchange="piapercentChange();"></asp:textbox>
                            </div>
                            <div class="col-md-12 col-sm-12 form-group-sm">
                            ...
                            <div class="col-md-12 col-sm-12 form-group-sm">
                                <small>PIA % Value</small>
                                <asp:textbox id="pia_value" runat="server" cssclass="form-control"></asp:textbox>
                            </div>
                        </div>
                    </div>
                </asp:Panel>
