...
function loadJS(e, t) {
    for (i = 0; i < e.length; i++) {
        ...
        r.type = "text/javascript"; r.async = !1; r.src = e[i]; n.appendChild(r)
    }
    if (t) {
        var n = document.getElementsByTagName("body")[0], r = document.createElement("script");
        r.type = "text/javascript"; r.async = !1; r.src = t; n.appendChild(r)
    }
    init()
}
...
function loadCSS(e, t, n) {
    if (!cssArray[e]) {
        cssArray[e] = !0; if (t == 1) {
            ...
            i.setAttribute("href", e); i.onload = n; r.appendChild(i)
        } else {
...
function loadPage(e) {
    $.ajax({ type: "GET", url: $.subPagesDirectory + e, dataType: "html", cache: !1, async: !1, beforeSend: function () { $.mainContent.css({ opacity: 0 }) }, success: function () { Pace.restart(); $("html, body").animate({ scrollTop: 0 }, 0); $.mainContent.load($.subPagesDirectory + e, null, function (t) { window.location.hash = e }).delay(250).animate({ opacity: 1 }, 750) }, error: function () { window.location.href = $.page404 } })
}
function init() {
    $(".panel-minimized").find(".panel-actions i." + $.panelIconOpened).removeClass($.panelIconOpened).addClass($.panelIconClosed); $('[rel="tooltip"],[data-rel="tooltip"]').tooltip({ placement: "bottom", delay: { show: 400, hide: 200 } }); $('[rel="popover"],[data-rel="popover"],[data-toggle="popover"]').popover()
}
...
function todoList() {
    ...
    $(".todo-list-tasks").on("change", ".custom-checkbox", function () {
        ...
        $(this).parent().parent().slideUp("slow", function () {
            $(this).remove(); $(".todo-list-tasks li").length == 0 && $(".todo-list-tasks").html("<!--empty-->")
        })
    });
...
function startTime() {
    ...
    n = checkTime(n); r = checkTime(r);
    document.getElementById("clock").innerHTML = t + ":" + n + ":" + r;
    var i = setTimeout(function () { startTime() }, 500)
}
...
function widthFunctions(e) {
    ...
    if (!$("body").hasClass("static-sidebar")) {
        ...
        if (i < 992) var u = s + o; else var u = t + s + o;
...
if ($.ajaxLoad) {
    ...
    $(document).on("click", '.nav a[href!="#"]', function (e) {
        if ($(this).parent().parent().hasClass("nav-tabs") || $(this).parent().parent().hasClass("nav-pills"))
            ...
            e.preventDefault(); $this = $(e.currentTarget); window.location = $this.attr("href")
...
$(document).ready(function (e) {
    ...
    e("ul.nav-sidebar").find("a").each(function () {
        ...
        if (e(e(this))[0].href == t) {
            ...
            e(this).parents("ul").add(this).each(function () { e(this).show().parent().addClass("opened") })
        }
    });
    e(".nav-sidebar").on("click", "a", function (t) {
        e.ajaxLoad && t.preventDefault();
        if (!e(this).parent().hasClass("hover")) if (e(this).parent().find("ul").size() != 0) { e(this).parent().hasClass("opened") ? e(this).parent().removeClass("opened") : e(this).parent().addClass("opened"); e(this).parent().find("ul").first().slideToggle("slow", function () { dropSidebarShadow() }); e(this).parent().parent().find("ul").each(function () { e(this).parent().hasClass("opened") || e(this).slideUp() }); e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("slow", function () { e(this).parent().removeClass("opened").find(".opened").each(function () { e(this).removeClass("opened") }) }) } else e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("slow", function () { e(this).parent().removeClass("opened").find(".opened").each(function () { e(this).removeClass("opened") }) })
    });
    ...
    e("#sidebar-minify").click(function () {
        if (e("body").hasClass("sidebar-minified")) {
            e("body").removeClass("sidebar-minified"); e("#sidebar-minify i").removeClass("fa-list").addClass("fa-ellipsis-v")
        } else {
            e("body").addClass("sidebar-minified"); e("#sidebar-minify i").removeClass("fa-ellipsis-v").addClass("fa-list")
        }
    });
    widthFunctions();
    dropSidebarShadow();
    init(); e(".sidebar").mmenu();
    e('a[href="#"][data-top!=true]').click(function (e) { e.preventDefault() })
});
$(document).on("click", ".panel-actions a", function (e) {
    e.preventDefault();
    if ($(this).hasClass("btn-closei")) $(this).parent().parent().fadeOut();
    else if ($(this).hasClass("btn-close")) $(this).parent().parent().parent().fadeOut();
        ...
        t.slideToggle("slow", function () { widthFunctions() })
